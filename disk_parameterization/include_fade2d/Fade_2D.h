...
* @param inFile is an ASCII file containing three coordinates per line
* @param vCornersOut contains point triples i.e., {0,1,2} forms the
* first triangle, {3,4,5} the second one and so on.
*/
CLASS_DECLSPEC
...
/** \brief Tentative interface for surface reconstruction
* @param inFile is an ASCII file containing three coordinates per line
* @param outFile is an *.obj file name
*/
CLASS_DECLSPEC
...
/** \brief Tentative interface for surface reconstruction
* @param vInPoints contains the input point cloud
* @param vCornersOut contains point triples i.e., {0,1,2} forms the
* first triangle, {3,4,5} the second one and so on.
*/
CLASS_DECLSPEC
